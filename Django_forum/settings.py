...
SECRET_KEY = 'django-insecure-5u6wnuc&_d=o#sr9tw!l&8syq^g%p&a31+7u)0+$z_7&i)cfis'
...
cloudinary.config(
    cloud_name="dpkeiqsts",
    api_key="135568217718212",
    api_secret="xt2Fz5G3HLxeV0D-8VhcsDPg8Tg",
)
